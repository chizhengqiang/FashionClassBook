...
public class CategoryController {
    ...
    @ApiOperation("修改")
    public ServerResponse<String> updateCategory(@RequestBody CategoryReq categoryReq) throws FCBException {
    ...
    @ApiOperation("删除")
    public ServerResponse<String> updateCategory(@PathVariable @NotNull Long id) throws FCBException {
