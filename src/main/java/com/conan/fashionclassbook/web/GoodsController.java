...
public class GoodsController {
    ...
    @GetMapping("/goods/{id}")
    @ApiOperation("获取一个")
    public ServerResponse<GoodsResp> getById(@PathVariable Long id)  {
    ...
    @PostMapping("/goods")
    @ApiOperation("增加")
    public ServerResponse<String> addGoods(@RequestBody GoodsReq req)  {
    ...
    @PutMapping("/goods")
    @ApiOperation("修改一个")
    public ServerResponse<String> editGoods(@RequestBody GoodsReq req)  {
    ...
    @ApiOperation("删除")
    public ServerResponse<String> deleteById(@PathVariable Long id)  {
